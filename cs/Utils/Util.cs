...
namespace $safeprojectname$
{
    ...
    return e;
        ...
        public static Element NewSelection(UIDocument uidoc, Document doc)
        {

        try
        {
            Reference refElement = uidoc.Selection.PickObject(ObjectType.Element, "Please pick an element in the model");
            return doc.GetElement(refElement);
        }
        catch
        {
            return null;
